...
<script src="../btstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="../btstrap/js/jquery.js" type="text/javascript"></script>
...
<div class="row">
<div class="col-sm-12" style="min-height:700px;background:rgba(0,0,0,.5);">
<div class="col-sm-7 a" >
WELCOME TO <b style="color:#ff4444;font-size:45px;">E-</b> Study <b style="color:#ff4444;font-size:45px;">Zone</b>
</div>
